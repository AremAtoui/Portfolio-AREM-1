    ...
    return (
        <div style={{background:"white"}}>
            <section id="about" class="active">
                ...
                <p class="d-block d-md-none"> a Freelance UI/UX Designer and Developer based in London, England. I strives to build immersive and beautiful web applications through carefully crafted code and user-centric design.</p></div><div class="row col-xl-6 col-lg-6 col-md-12"><div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <ul class="list-1" style={{listStyle:"none", marginLeft: "-103px"}}><li><h6><span class="font-weight-600">First Name</span> Arem</h6></li><li><h6><span class="font-weight-600">Last Name</span> Atoui</h6></li><li><h6><span class="font-weight-600">Birthdate</span> 23-11-1996</h6></li><li><h6><span class="font-weight-600">Nationality</span> Tunisian</h6></li><li><h6><span class="font-weight-600">Address</span> Tunisia</h6></li></ul></div><div class="col-xl-6 col-lg-6 col-md-6 col-sm-6"><ul class="list-2" style={{listStyle:"none"}}><li><h6><span class="font-weight-600">Langages</span> Frensh</h6></li><li><h6><span class="font-weight-600">Phone</span> +216 27 793 044</h6></li><li><h6><span class="font-weight-600">Email</span> arem.atoui@isimg.tn</h6></li><li><h6><span class="font-weight-600"></span></h6></li></ul></div>
                 
                
    <a href={CV} download className='btn primary' style={{backgroundColor:"#72b626", width:"143px", position: "absolute",
    top: "160px",
    left: "-104px"}}>Download CV <HiDownload/></a>
                            ...
                            <div class="">
                                <div class="card-header"><span class="year">
                                    ...
                                    <span class="d-block font-weight-400 uppercase">fundamental licence-ISIM<span class="separator"></span>
                                        <span class="font-weight-700">Gabes</span></span></div>
                                <div class="card-body"><p style={{width:"500px"}}>Web application consists of modernizing the IT management of a gym so as to be able to offer members and trainers several online services via their Smartphones.
